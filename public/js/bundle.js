...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    var _loc$coordinates = _slicedToArray(loc.coordinates, 2),
      ...
      lat = _loc$coordinates[1]; // GeoJSON is [lng, lat]
    var marker = L.marker([lat, lng]).addTo(map);
    marker.bindPopup("<strong>".concat(loc.description, "</strong><br>Day ").concat(loc.day));
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "changes successfully saved");
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var savePasswordBtn = document.getElementById('save-settings-password');
  ...
  if (saveSettingsBtn) {
    saveSettingsBtn.addEventListener('click', /*#__PURE__*/function () {
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            case 0:
              ...
              _context.n = 1;
              return (0, _updateSettings.updateSettings)(form, "name,email");
            case 1:
  ...
  if (savePasswordBtn) {
    savePasswordBtn.addEventListener('click', /*#__PURE__*/function () {
